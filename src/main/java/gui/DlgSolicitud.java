...
public class DlgSolicitud extends JDialog implements ActionListener {
	...
	void listar() {
		...
		String jpql = "select s, a.descripcion, a.fechaInicio, a.nroVacantes, c.descripcion  from Solicitud s join s.actividad a join a.categoria c order by s.nroSolicitud";
		...
		try {
			...
			for (Object[] objects : resultados) {
				...
				String descActividad = (String) objects[1]; 
				Date fechaInicio = (Date) objects[2]; 
				Integer nroVacantes = (Integer) objects[3];
				String descCategoria = (String) objects[4];
				
				imprimir("Nro. Solicitud..........: "+ solicitud.getNroSolicitud());
				imprimir("Fecha de registro.......: "+ sdf.format(solicitud.getFechaReg()));
				imprimir("Actividad...............: "+ solicitud.getActividad().getIdActividad() + " - " + descActividad );
				imprimir("Fecha de inicio.........: "+ sdf.format(fechaInicio));
				imprimir("Nro. de vacantes........: "+ nroVacantes );
				imprimir("Categoria...............: "+ solicitud.getActividad().getCategoria() + " - " + descCategoria);
	...
	void adicionar() {
		...
		Solicitud solicitud = new Solicitud(estado, archivoAdjunto, actividad);
	...
	void buscar() {	
	    ...
	    try {
	        ...
	        txtFechaRegistro.setText(solicitud.getFechaReg().toString().split(" ")[0]);
